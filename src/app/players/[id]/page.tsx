    ...
    <main className="page-shell">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <section className="section-band">
          ...
          <h2 className="mt-8 text-xl font-black">Season {seasonLabel}</h2>
          ...
          <div className="mt-4">
            {headToHead.length === 0 ? (
              <EmptyState title="No opponents yet" body="Head-to-head records appear once this player has played a match." />
            ) : (
