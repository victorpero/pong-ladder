...
import { ACTIVE_PATH_HEADER, DEFAULT_LOCALE, localeFromPathname } from "@/lib/i18n/config";
  ...
  return (
    <main className="page-shell">
      <section className="section-band mx-auto max-w-xl text-center">
        <p className="label">{dictionary.notFound.label}</p>
        <h1 className="mt-2 text-3xl font-black">{dictionary.notFound.heading}</h1>
        <p className="mt-3 text-sm leading-6 text-muted">{dictionary.notFound.body}</p>
