...
import { AuthForms } from "@/app/[locale]/login/AuthForms";
...
export function generateMetadata({ params }: { params: { locale: string } }): Metadata {
  return { title: getDictionary(params.locale).metadata.loginTitle };
}

function getSafeNextPath(locale: ReturnType<typeof toSupportedLocale>, next?: string | string[]) {
...
export default function LoginPage({
  ...
  const nextPath = getSafeNextPath(locale, searchParams.next);
